...
@Service
public class OldStep0Service implements DemoService {
    private static final Logger logger = LoggerFactory.getLogger(OldStep0Service.class);

    private KafkaManager kafkaManager;
    private Disposable disposable;

    public OldStep0Service(KafkaManager kafkaManager) {
