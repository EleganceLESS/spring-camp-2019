...
@Service
public class Step00Service extends AbsDemoService {
    private static final Logger logger = LoggerFactory.getLogger(Step00Service.class);

    public Step00Service(KafkaManager kafkaManager) {
