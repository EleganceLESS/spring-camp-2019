...
@Service
public class Step05Service extends AbsDemoService implements RandomNumberGenerator {
    private static final Logger logger = LoggerFactory.getLogger(Step05Service.class);

    public Step05Service(KafkaManager kafkaManager) {
