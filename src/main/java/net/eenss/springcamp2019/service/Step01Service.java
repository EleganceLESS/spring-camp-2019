...
@Service
public class Step01Service extends AbsDemoService implements IntegerRecordReader {
    private static final Logger logger = LoggerFactory.getLogger(Step01Service.class);

    private SomeRepository repository;

    public Step01Service(KafkaManager kafkaManager, SomeRepository repository) {
