...
@Service
public class OldStep1Service implements DemoService {
    private static final Logger logger = LoggerFactory.getLogger(OldStep1Service.class);

    private KafkaManager configure;
    private SomeRepository repository;

    public OldStep1Service(KafkaManager configure, SomeRepository repository) {
