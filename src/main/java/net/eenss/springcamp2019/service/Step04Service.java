...
@Service
public class Step04Service extends AbsDemoService implements RandomNumberGenerator {
    private static final Logger logger = LoggerFactory.getLogger(Step04Service.class);

    public Step04Service(KafkaManager kafkaManager) {
