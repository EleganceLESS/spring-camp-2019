...
@Service
public class OldStep4Service implements DemoService {
    private static final Logger logger = LoggerFactory.getLogger(OldStep4Service.class);

    private KafkaManager kafkaManager;
    private Disposable disposable;

    public OldStep4Service(KafkaManager kafkaManager) {
